...
$(function () {
  $('.firstPage-topButton').hide();
  $(window).scroll(function () {
    if ($(this).scrollTop() > 300) {
      $('.firstPage-topButton').fadeIn(500);
    } else {
      $('.firstPage-topButton').fadeOut(100);
    }
  });
  $(window).scroll(function () {
    if ($(window).scrollTop() > $('.works__pagination').offset().top) {
      $('.anim').addClass('skillBarValue');
    } else {
      $('.anim').removeClass('skillBarValue');
    }
  });
});
setTimeout(() => {
...
text.innerHTML = `Tashkent ${date} : ${min}`;